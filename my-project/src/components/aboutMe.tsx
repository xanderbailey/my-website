      ...
      <div className="lg:space-x-5 lg:-mx-4 flex flex-col justify-center items-center">
        <div className="flex-1 lg:mt-12 lg:px-4 mb-10">
          ...
          <div className="flex flex-row justify-center mt-6">
            <div className="flex md:flex lg:flex sm:flex space-x-4 font-medium text-gray-800 dark:text-white">
              <a
                className="transition-colors hover:text-sky-500"
                target="_blank"
                rel="noreferrer"
                href="https://twitter.com/xanderrbailey"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                href="https://www.linkedin.com/in/xander-bailey-7a729595/"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                href="https://github.com/xanderbailey"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                href="https://medium.com/@alexanderbailey"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
